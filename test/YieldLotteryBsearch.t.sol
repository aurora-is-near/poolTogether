...
import "../src/YieldLotteryBsearch.sol";

contract YieldTestBsearch is Test {
    YieldLotteryBsearch public lottery;
    ...
    function setUp() public {
        lottery = new YieldLotteryBsearch(address(this));
        lottery.init(1 hours, aurora, jetStaking, streamTokens);
    }

    function testFullFunctionality() public {
        buyTicket(user1, 2000);
        buyTicket(user2, 2000);
        buyTicket(user3, 2000);
        lottery.stake();
